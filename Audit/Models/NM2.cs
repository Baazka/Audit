        ...
        public NM2 SetXml(XElement xml)
        {
            if (xml != null)
            {
                ...
                if (xml.Element("CLAIM_VIOLATION_AMOUNT") != null)
                    CLAIM_VIOLATION_AMOUNT = Convert.ToDecimal(xml.Element("CLAIM_VIOLATION_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("CLAIM_C2_AMOUNT") != null)
                    CLAIM_C2_AMOUNT = Convert.ToDecimal(xml.Element("CLAIM_C2_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("CLAIM_C2_NONEXPIRED_AMOUNT") != null)
                    CLAIM_C2_NONEXPIRED_AMOUNT = Convert.ToDecimal(xml.Element("CLAIM_C2_NONEXPIRED_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("CLAIM_C2_EXPIRED_AMOUNT") != null)
                    CLAIM_C2_EXPIRED_AMOUNT = Convert.ToDecimal(xml.Element("CLAIM_C2_EXPIRED_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("BENEFIT_NONFIN_AMOUNT") != null)
                    BENEFIT_NONFIN_AMOUNT = Convert.ToDecimal(xml.Element("BENEFIT_NONFIN_AMOUNT").Value).ToString("#,0.00");
