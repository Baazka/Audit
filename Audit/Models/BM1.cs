    ...
    public class BM1List
    {
        ...
        public BM1List SetXml(XElement xml)
        {
            if (xml != null)
            {
                ...
                if (xml.Element("ACT_LOCAL_AMOUNT") != null)
                    ACT_LOCAL_AMOUNT = Convert.ToDecimal(xml.Element("ACT_LOCAL_AMOUNT").Value).ToString("#,0.##");
                if (xml.Element("ACT_ORG_AMOUNT") != null)
                    ACT_ORG_AMOUNT = Convert.ToDecimal(xml.Element("ACT_ORG_AMOUNT").Value).ToString("#,0.##");
                if (xml.Element("ACT_OTHER_AMOUNT") != null)
                    ACT_OTHER_AMOUNT = Convert.ToDecimal(xml.Element("ACT_OTHER_AMOUNT").Value).ToString("#,0.##");
                if (xml.Element("ACT_RCV_NAME") != null)
                    ACT_RCV_NAME = xml.Element("ACT_RCV_NAME").Value;
                if (xml.Element("ACT_RCV_ROLE") != null)
                    ACT_RCV_ROLE = xml.Element("ACT_RCV_ROLE").Value;
                ...
                if (xml.Element("ACT_C2_NONEXPIRED") != null)
                    ACT_C2_NONEXPIRED = Convert.ToDecimal(xml.Element("ACT_C2_NONEXPIRED").Value).ToString("#,0.##");
                if (xml.Element("ACT_C2_EXPIRED") != null)
                    ACT_C2_EXPIRED = Convert.ToDecimal(xml.Element("ACT_C2_EXPIRED").Value).ToString("#,0.##");
                if (xml.Element("BENEFIT_FIN") != null)
                    BENEFIT_FIN = Convert.ToInt32(xml.Element("BENEFIT_FIN").Value);
                if (xml.Element("BENEFIT_FIN_AMOUNT") != null)
