...
namespace Audit.Models
{
    ...
    public class CM2
    {
        ...
        public int COMP_STATE_AMOUNT { get; set; }
        public int COMP_LOCAL_COUNT { get; set; }
        public int COMP_LOCAL_AMOUNT { get; set; }
        public int COMP_ORG_COUNT { get; set; }
        public int COMP_ORG_AMOUNT { get; set; }
        public int COMP_OTHER_COUNT { get; set; }
        public int COMP_OTHER_AMOUNT { get; set; }
        public int STATISTIC_COUNT { get; set; }
        public int STATISTIC_AMOUNT { get; set; }
        ...
        public CM2 SetXml(XElement xml)
        {
            if (xml != null)
            {
                ...
                if (xml.Element("PREV_AMOUNT") != null)
                    PREV_AMOUNT = Convert.ToInt32(xml.Element("PREV_AMOUNT").Value);
                if (xml.Element("CY_COUNT") != null)
                    CY_COUNT = Convert.ToInt32(xml.Element("CY_COUNT").Value);
                if (xml.Element("CY_AMOUNT") != null)
                    CY_AMOUNT = Convert.ToInt32(xml.Element("CY_AMOUNT").Value);
                ...
                if (xml.Element("COMP_STATE_AMOUNT") != null)
                    COMP_STATE_AMOUNT = Convert.ToInt32(xml.Element("COMP_STATE_AMOUNT").Value);
                ...
                if (xml.Element("COMP_LOCAL_AMOUNT") != null)
                    COMP_LOCAL_AMOUNT = Convert.ToInt32(xml.Element("COMP_LOCAL_AMOUNT").Value);
                ...
                if (xml.Element("COMP_ORG_AMOUNT") != null)
                    COMP_ORG_AMOUNT = Convert.ToInt32(xml.Element("COMP_ORG_AMOUNT").Value);
                ...
                if (xml.Element("COMP_OTHER_AMOUNT") != null)
                    COMP_OTHER_AMOUNT = Convert.ToInt32(xml.Element("COMP_OTHER_AMOUNT").Value);
                ...
                if (xml.Element("STATISTIC_AMOUNT") != null)
                    STATISTIC_AMOUNT = Convert.ToInt32(xml.Element("STATISTIC_AMOUNT").Value);
