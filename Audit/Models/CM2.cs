        ...
        public CM2 SetXml(XElement xml)
        {
            if (xml != null)
            {
                ...
                if (xml.Element("C1_AMOUNT") != null)
                    C1_AMOUNT = Convert.ToDecimal(xml.Element("C1_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("COMP_STATE_AMOUNT") != null)
                    COMP_STATE_AMOUNT = Convert.ToDecimal(xml.Element("COMP_STATE_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("COMP_LOCAL_AMOUNT") != null)
                    COMP_LOCAL_AMOUNT = Convert.ToDecimal(xml.Element("COMP_LOCAL_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("COMP_ORG_AMOUNT") != null)
                    COMP_ORG_AMOUNT = Convert.ToDecimal(xml.Element("COMP_ORG_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("COMP_OTHER_AMOUNT") != null)
                    COMP_OTHER_AMOUNT = Convert.ToDecimal(xml.Element("COMP_OTHER_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("STATISTIC_AMOUNT") != null)
                    STATISTIC_AMOUNT = Convert.ToDecimal(xml.Element("STATISTIC_AMOUNT").Value).ToString("#,0.00");
                if (xml.Element("C2_COUNT") != null)
                    C2_COUNT = Convert.ToInt32(xml.Element("C2_COUNT").Value);
                if (xml.Element("C2_AMOUNT") != null)
                    C2_AMOUNT = Convert.ToDecimal(xml.Element("C2_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("C2_NONEXPIRED_AMOUNT") != null)
                    C2_NONEXPIRED_AMOUNT = Convert.ToDecimal(xml.Element("C2_NONEXPIRED_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("C2_EXPIRED_AMOUNT") != null)
                    C2_EXPIRED_AMOUNT = Convert.ToDecimal(xml.Element("C2_EXPIRED_AMOUNT").Value).ToString("#,0.00");
