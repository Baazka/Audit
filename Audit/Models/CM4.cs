...
namespace Audit.Models
{
    ...
    public class CM4
    {
        ...
        public int VIOLATION_AMOUNT { get; set; }
        public int ERROR_COUNT { get; set; }
        public int ERROR_AMOUNT { get; set; }
        public int ALL_COUNT { get; set; }
        public int ALL_AMOUNT { get; set; }
        public int CORRECTED_ERROR_COUNT { get; set; }
        public int CORRECTED_ERROR_AMOUNT { get; set; }
        public int OTHER_ERROR_COUNT { get; set; }
        public int OTHER_ERROR_AMOUNT { get; set; }
        ...
        public CM4 SetXml(XElement xml)
        {
            if (xml != null)
            {
                ...
                if (xml.Element("VIOLATION_AMOUNT") != null)
                    VIOLATION_AMOUNT = Convert.ToInt32(xml.Element("VIOLATION_AMOUNT").Value);
                if (xml.Element("ERROR_COUNT") != null)
                    ERROR_COUNT = Convert.ToInt32(xml.Element("ERROR_COUNT").Value);
                if (xml.Element("ERROR_AMOUNT") != null)
                    ERROR_AMOUNT = Convert.ToInt32(xml.Element("ERROR_AMOUNT").Value);         
                ...
                if (xml.Element("CORRECTED_ERROR_AMOUNT") != null)
                    CORRECTED_ERROR_AMOUNT = Convert.ToInt32(xml.Element("CORRECTED_ERROR_AMOUNT").Value);
                ...
                if (xml.Element("OTHER_ERROR_AMOUNT") != null)
                    OTHER_ERROR_AMOUNT = Convert.ToInt32(xml.Element("OTHER_ERROR_AMOUNT").Value);
                ...
                if (xml.Element("CLAIM_AMOUNT") != null)
                    CLAIM_AMOUNT = Convert.ToInt32(xml.Element("CLAIM_AMOUNT").Value);
