...
namespace Audit.Models
{
    ...
    public class CM6
    {
        ...
        public string ALL_C2_AMOUNT { get; set; }
        ...
        public CM6 SetXml(XElement xml)
        {
            if (xml != null)
            {
                ...
                if (xml.Element("ALL_AMOUNT") != null)
                    ALL_AMOUNT = xml.Element("ALL_AMOUNT").Value;
                ...
                if (xml.Element("ALL_C2_AMOUNT") != null)
                    ALL_C2_AMOUNT = xml.Element("ALL_C2_AMOUNT").Value;
        ...
        public XElement ToXml()
        {
            return new XElement("CM6",
                       ...
                       ALL_AMOUNT != null ? new XElement("ALL_AMOUNT", ALL_AMOUNT.Split(',')) : new XElement("ALL_AMOUNT", null),
                       ...
                       ALL_C2_AMOUNT != null ? new XElement("ALL_C2_AMOUNT", ALL_C2_AMOUNT.Split(',')) : new XElement("ALL_C2_AMOUNT", null),
    ...
    public class CM6List
    {
        ...
        public string ALL_AMOUNT { get; set; }
        public int? PROCESSED_INCOMED_COUNT { get; set; }
        public string PROCESSED_INCOMED_AMOUNT { get; set; }
        public int? PROCESSED_COSTS_COUNT { get; set; }
        public string PROCESSED_COSTS_AMOUNT { get; set; }

        public int? ALL_C1_COUNT { get; set; }
        public string ALL_C2_AMOUNT { get; set; }
        public int? ACCEPTED_INCOMED_COUNT { get; set; }
        public string ACCEPTED_INCOMED_AMOUNT { get; set; }
        public int? ACCEPTED_COSTS_COUNT { get; set; }
        public string ACCEPTED_COSTS_AMOUNT { get; set; }
        ...
        public CM6List SetXml(XElement xml)
        {
            if (xml != null)
            {
                if (xml.Element("ID") != null)
                ...
                if (xml.Element("PROCESSED_INCOMED_COUNT") != null)
                    PROCESSED_INCOMED_COUNT = Convert.ToInt32(xml.Element("PROCESSED_INCOMED_COUNT").Value);
                if (xml.Element("PROCESSED_INCOMED_AMOUNT") != null)
                    PROCESSED_INCOMED_AMOUNT = Convert.ToDecimal(xml.Element("PROCESSED_INCOMED_AMOUNT").Value).ToString("#,0.00");
                if (xml.Element("PROCESSED_COSTS_COUNT") != null)
                    PROCESSED_COSTS_COUNT = Convert.ToInt32(xml.Element("PROCESSED_COSTS_COUNT").Value);
                if (xml.Element("PROCESSED_COSTS_AMOUNT") != null)
                    PROCESSED_COSTS_AMOUNT = Convert.ToDecimal(xml.Element("PROCESSED_COSTS_AMOUNT").Value).ToString("#,0.00");
                if (xml.Element("ALL_C1_COUNT") != null)
                    ALL_C1_COUNT = Convert.ToInt32(xml.Element("ALL_C1_COUNT").Value);
                if (xml.Element("ALL_C2_AMOUNT") != null)
                    ALL_C2_AMOUNT = Convert.ToDecimal(xml.Element("ALL_C2_AMOUNT").Value).ToString("#,0.00");
                if (xml.Element("ACCEPTED_INCOMED_COUNT") != null)
                    ACCEPTED_INCOMED_COUNT = Convert.ToInt32(xml.Element("ACCEPTED_INCOMED_COUNT").Value);
                if (xml.Element("ACCEPTED_INCOMED_AMOUNT") != null)
                    ACCEPTED_INCOMED_AMOUNT = Convert.ToDecimal(xml.Element("ACCEPTED_INCOMED_AMOUNT").Value).ToString("#,0.00");
                if (xml.Element("ACCEPTED_COSTS_COUNT") != null)
                    ACCEPTED_COSTS_COUNT = Convert.ToInt32(xml.Element("ACCEPTED_COSTS_COUNT").Value);
                if (xml.Element("ACCEPTED_COSTS_AMOUNT") != null)
                    ACCEPTED_COSTS_AMOUNT = Convert.ToDecimal(xml.Element("ACCEPTED_COSTS_AMOUNT").Value).ToString("#,0.00");
