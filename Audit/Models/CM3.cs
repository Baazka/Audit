        ...
        public CM3 SetXml(XElement xml)
        {
            if (xml != null)
            {
                ...
                if (xml.Element("LAW_CURRENT_AMOUNT") != null)
                    LAW_CURRENT_AMOUNT = Convert.ToDecimal(xml.Element("LAW_CURRENT_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("LAW_TOTAL_AMOUNT") != null)
                    LAW_TOTAL_AMOUNT = Convert.ToDecimal(xml.Element("LAW_TOTAL_AMOUNT").Value).ToString("#,0.00");                
                ...
                if (xml.Element("LAW_COMP_DONE_AMOUNT") != null)
                    LAW_COMP_DONE_AMOUNT = Convert.ToDecimal(xml.Element("LAW_COMP_DONE_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("LAW_COMP_PROG_AMOUNT") != null)
                    LAW_COMP_PROG_AMOUNT = Convert.ToDecimal(xml.Element("LAW_COMP_PROG_AMOUNT").Value).ToString("#,0.00");
                ...
                if (xml.Element("LAW_COMP_INVALID_AMOUNT") != null)
                    LAW_COMP_INVALID_AMOUNT = Convert.ToDecimal(xml.Element("LAW_COMP_INVALID_AMOUNT").Value).ToString("#,0.00");
