...
namespace Audit.Controllers.Library
{
    public class SystemController : _Controller
    {
        ...
        public XElement BM0(XElement element, string usertype, string departmentid, string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement BM1(XElement element, string usertype, string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public bool BM1UpdateCompletion(int userid, XElement element)
        {
            try
            {
                ClearError();
                ...
                XElement requestXml = new XElement("Request",
                                               new XElement("Function", "BM1UpdateCompletion"),
                                               new XElement("Parameters",
                                                   new XElement("USER_ID", userid),
                                                   element));
        ...
        public XElement BM2(XElement element, string usertype, string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement BM3(XElement element, string usertype, string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement BM4(XElement element, string usertype, string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement BM5(XElement element, string usertype, string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement BM6(XElement element, string usertype, string departmentid, string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement BM7(XElement element, string usertype, string departmentid, string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement BM8(XElement element, string usertype, string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        #endregion
        #region NM
        public XElement NM1(XElement element, string usertype, string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement NM2(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement NM3(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement NM4(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement NM5(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement NM6(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement NM7(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        #endregion
        #region CM
        public XElement CM1(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement CM2(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement CM3(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement CM4(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement CM5(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement CM6(XElement element, string usertype,string departmentid ,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement CM7(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
        ...
        public XElement CM8(XElement element, string usertype,string departmentid,string userid)
        {
            try
            {
                ClearError();
