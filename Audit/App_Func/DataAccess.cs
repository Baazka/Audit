    ...
    public class DataAccess
    {
        ...
        public static DataResponse ReportN1(XElement request)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "WITH negtgel1 AS( " +
                                        "SELECT * FROM (" +
                                        "SELECT ORGID, YEARCODE, INSERTUSERID, MDCODE, DATA01, AE.ENT_NAME AS PARENT_NAME, ROP.OPEN_ENT_NAME AS ORGNAME, ROP.open_ent_register_no,C.BUDGET_TYPE_NAME AS ORGTYPE,ROP.OPEN_HEAD_ROLE, ROP.OPEN_HEAD_NAME, ROP.OPEN_HEAD_PHONE, ROP.OPEN_ACC_ROLE, ROP.OPEN_ACC_NAME , ROP.OPEN_ACC_PHONE FROM AUD_MIRRORACC.SHILENDANSDATA A " +
                                        ...
                                        ") P1 " +
                                        ") " +
                                        "SELECT ORGID, INSERTUSERID,open_ent_register_no,PARENT_NAME,ORGNAME,ORGTYPE,OPEN_HEAD_ROLE, OPEN_HEAD_NAME, OPEN_HEAD_PHONE,OPEN_ACC_ROLE, OPEN_ACC_NAME ,OPEN_ACC_PHONE, " +
        ...
        public static DataResponse Report1N2(XElement request)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "WITH Negtgel2 AS( " +
                               "SELECT* FROM( " +
                               "SELECT ORGID, YEARCODE, INSERTUSERID, MDCODE, DATA01, AE.ENT_NAME AS PARENT_NAME, ROP.OPEN_ENT_NAME AS ORGNAME, C.BUDGET_TYPE_NAME AS ORGTYPE, ROP.open_ent_register_no, ROP.OPEN_HEAD_ROLE, ROP.OPEN_HEAD_NAME, ROP.OPEN_HEAD_PHONE, ROP.OPEN_ACC_ROLE, ROP.OPEN_ACC_NAME , ROP.OPEN_ACC_PHONE FROM AUD_MIRRORACC.SHILENDANSDATA A " +
                               "INNER JOIN AUD_MIRRORACC.OPENACC_ENTITY ROP ON A.ORGID = ROP.OPEN_ID " +
                               "INNER JOIN AUD_MIRRORACC.REF_BUDGET_TYPE C ON ROP.OPEN_ENT_BUDGET_TYPE = C.BUDGET_TYPE_ID " +
                               "LEFT JOIN AUD_ORG.AUDIT_ENTITY AE ON ROP.OPEN_ENT_TEZ = AE.ENT_ID " +
                               ...
                               ") P1 " +
                               ") " +
                               "SELECT ORGID, PARENT_NAME, ORGNAME, ORGTYPE, INSERTUSERID, open_ent_register_no, " +
        ...
        public static DataResponse ReportN2(XElement request)
        {
            ...
            try
            {
                ...
                " ) P1 " +
                " ) " +
                " SELECT ORGID, YEARCODE, INSERTUSERID, PARENT_NAME, ORGNAME, ORGTYPE,OPEN_HEAD_ROLE,OPEN_HEAD_NAME,OPEN_HEAD_PHONE,OPEN_ACC_ROLE, OPEN_ACC_NAME , OPEN_ACC_PHONE, open_ent_register_no, " +
