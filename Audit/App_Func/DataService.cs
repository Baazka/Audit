...
namespace Audit.App_Func
{
    public class DataService
    {
        ...
        public DataService()
        {
            ...
            functions.Add("BM2UpdateCompletion", (request) => DataAccess.BM2UpdateCompletion(request));
            functions.Add("BM2Delete", (request) => DataAccess.BM2Delete(request));
            functions.Add("BM3", (request) => DataAccess.BM3(request));
            functions.Add("BM3SelectAdd", (request) => DataAccess.BM3SelectAdd(request));
            ...
            functions.Add("BM3UpdateCompletion", (request) => DataAccess.BM3UpdateCompletion(request));
            functions.Add("BM3Delete", (request) => DataAccess.BM3Delete(request));
            functions.Add("BM4", (request) => DataAccess.BM4(request));
            functions.Add("BM4SelectAdd", (request) => DataAccess.BM4SelectAdd(request));
            ...
            functions.Add("BM4UpdateCompletion", (request) => DataAccess.BM4UpdateCompletion(request));
            functions.Add("BM4Delete", (request) => DataAccess.BM4Delete(request));
            functions.Add("BM5", (request) => DataAccess.BM5(request));
            functions.Add("BM5SelectAdd", (request) => DataAccess.BM5SelectAdd(request));
            ...
            functions.Add("BM5UpdateCompletion", (request) => DataAccess.BM5UpdateCompletion(request));
            ...
            functions.Add("BM8SelectAdd", (request) => DataAccess.BM8SelectAdd(request));
